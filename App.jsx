...
const Bonus = ({ onOpenModal }) => {
  const items = [
    ...
    { Icon: Zap, label: "Skills", short: "" /* solo se muestra como icono en el grid; no aparece en la lista de bullets */ },
  ];
  return (
    <section className="relative py-14 md:py-28 px-4 sm:px-6">
      <div className="max-w-[1180px] mx-auto">
...
const CALENDAR_URL = "https://www.addevent.com/event/kz7qhnqbsrv3";
